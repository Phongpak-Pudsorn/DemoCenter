...
object Login {
    ...
    get() {
        ...
        appPref.setPreferences(mContext,AppPreferencesLogin.KEY_PREFS_LOGIN, value)
    }
    ...
    get() {
        ...
        appPref.setPreferences(mContext,AppPreferencesLogin.KEY_PREFS_REMEMBER_CHECK, value)
    }
    ...
    get(){
        ...
        return result
    }set(value) = appPref.setPreferences(mContext,AppPreferencesLogin.KEY_PREFS_USERID,value)
    ...
    get() {
        ...
        return result
    }set(value) = appPref.setPreferences(mContext,AppPreferencesLogin.KEY_PREFS_IDX,value)
    ...
    get() {
        ...
        return result
    }set(value) = appPref.setPreferences(mContext,AppPreferencesLogin.KEY_PREFS_NAME,value)
    ...
    get() {
        ...
        return result
    }set(value) = appPref.setPreferences(mContext,AppPreferencesLogin.KEY_PREFS_AVATAR,value)
    ...
    get() {
        ...
        return result
    }set(value) = appPref.setPreferences(mContext,AppPreferencesLogin.KEY_PREFS_COIN,value)
    ...
    get() {
        ...
        return result
    } set(value) = appPref.setPreferences(mContext,AppPreferencesLogin.KEY_PREFS_REMEMBER_USER,value)
